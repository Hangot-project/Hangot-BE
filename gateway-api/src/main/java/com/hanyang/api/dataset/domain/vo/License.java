package com.hanyang.api.dataset.domain.vo;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.hanyang.api.core.exception.NullException;
...
public enum License {
    ...
    public static License findByLicense(String License) {
        return Stream.of(com.hanyang.api.dataset.domain.vo.License.values())
